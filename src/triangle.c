//
// Created by Axel Sanner on 15/06/2023.
//
// Stolen from https://pastebin.com/MgyckbKz

#include "triangle.h"
#include "vec3.h"
#include "aabb.h"

bool Triangle_Hit(const Ray3& r, double t_min, double t_max, HitRecord& rec) const
{
/*
...
bool Triangle_BoundingBox(AABB& output_box) const
{
